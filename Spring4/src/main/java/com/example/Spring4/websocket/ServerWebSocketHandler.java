    ...
    public void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        ...
        switch (request.getType()) {
            case "selectMgni":
                ...
                break;
            case "create":
                response = "response　：　"+mapper.writeValueAsString(mgniService.createSettlementMargin(request.getRequestList()));
                break;
            case "update":
                response = "response　：　"+mapper.writeValueAsString(mgniService.updateData(request.getRequestList()));
                break;
            case "delete":
                response = "response　：　"+mapper.writeValueAsString(mgniService.deleteData(request.getRequestList().getId()));
                break;
            case "exit":
