...
public class TrainTicket {
    ...
    public TrainTicket(CreateTrainTicketCommand request, String ticketNo, String trainUuid, Double price, CheckErrorException e) throws ParseException {
        //check
    ...
    //------------------------------------------------------------------------------------------------------------------
    public static TrainTicket create(CreateTrainTicketCommand request,String ticketNo, String trainUuid
            ,double price,CheckErrorException checkErrorException) throws ParseException {
        return new TrainTicket(request, ticketNo, trainUuid, price, checkErrorException);
    }
