...
import com.example.springhexpractice.service.serviceApi.CheckOutboundStatus;
import com.example.springhexpractice.service.serviceApi.TicketPrice;
    ...
    public void checkTrainStatus(CheckErrorException e,Integer trainNo) {
        ...
        if (code == 200) {
            ...
            if (!check.getStatus().equals("available")) {
                e.getCheckError().add(ErrorCode.TrainStatus);
